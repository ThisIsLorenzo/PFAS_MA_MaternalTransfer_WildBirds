...
summary(ma_model1)
i2_ml(ma_model1)
orchard_plot(ma_model1, group = "study_ID", data = dat, xlab = "lnRR")
```
...
orchard_plot(ma_model1_noalbu, group = "study_ID", data = dplyr::filter(dat, sample_type_P != "albumen" ), xlab = "lnRR")
```
...
Now,
Determine the random effect structure filtering out albumen
```{r, eval=FALSE}
...
orchard_plot(ma_model2_noalbu, group = "study_ID", data = dplyr::filter(dat, sample_type_P != "albumen" ), xlab = "lnRR")
```
...
summary(mr_model1)
i2_ml(mr_model1)
orchard_plot(mr_model1, mod = "sample_type_P", group = "study_ID", data = dat, xlab = "lnRR")
```
...
summary(mr_model2)
i2_ml(mr_model2)
orchard_plot(mr_model2, mod = "sample_type_A", group = "study_ID", data = dat, xlab = "lnRR")
```
...
summary(mr_model3)
i2_ml(mr_model3)
bubble_plot(mr_model3, mod = "carbon_chain_length", group = "study_ID", data =dat , xlab = "carbon_chain_length")
```
...
bubble_plot(mr_model3_noalbumen, mod = "carbon_chain_length", group = "study_ID", data =dplyr::filter(dat, sample_type_P != "albumen") , xlab = "carbon_chain_length")
```
...
summary(mr_model4)
i2_ml(mr_model4)
bubble_plot(mr_model4, mod = "molecular_weight", group = "study_ID", data =dat, xlab = "molecular_weight")
...
bubble_plot(mr_model4_noalbumen, mod = "molecular_weight", group = "study_ID", data =dplyr::filter(dat, sample_type_P != "albumen") , xlab = "molecular_weight")
```
...
summary(mr_model6)
i2_ml(mr_model6)
orchard_plot(mr_model6, mod = "functional_group", group = "study_ID", data =dat, xlab = "lnRR")
```
...
orchard_plot(mr_model6_noalbumen, mod = "functional_group", group = "study_ID", data =dplyr::filter(dat, sample_type_P != "albumen"), xlab = "lnRR")
```

### Seabirds VS non-seabirds

```{r, eval = FALSE}
mr_model5 <- rma.mv(lnRR,
              VCV_lnRR,
              mods = ~ seabird,
              random = list(~1|study_ID, 
                            ~1|species_ID,
              ...
              test = "t",
              data = dat)
save(mr_model5, file = here("Rdata", "mr_model5.RData"))
```

```{r}
load(here("RData", "mr_model5.RData"))
summary(mr_model5)
i2_ml(mr_model5)
orchard_plot(mr_model5, mod = "seabird", group = "study_ID", data = dat, xlab = "lnRR")
```

Filtering out albumen

```{r, eval = FALSE}
mr_model5_noalbumen <- rma.mv(lnRR,
              VCV_lnRR_noalbumen,
              mods = ~ seabird,
              random = list(~1|study_ID, 
                            ~1|species_ID,
              ...
              test = "t",
              data = dplyr::filter(dat, sample_type_P != "albumen"))
save(mr_model5_noalbumen, file = here("Rdata", "mr_model5_noalbumen.RData"))
```

```{r}
load(here("RData", "mr_model5_noalbumen.RData"))
summary(mr_model5_noalbumen)
i2_ml(mr_model5_noalbumen)
orchard_plot(mr_model5_noalbumen, mod = "seabird", group = "study_ID", data = dplyr::filter(dat, sample_type_P != "albumen"), xlab = "lnRR")
```
