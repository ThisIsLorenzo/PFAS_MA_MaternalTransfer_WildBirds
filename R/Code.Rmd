...
We'll create two data sets to run a sensitivity analysis. The first data set will include all the data. The second will drop out data that are from pooled samples (i.e., from adult male + female pooled data)
