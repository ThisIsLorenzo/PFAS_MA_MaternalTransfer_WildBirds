...
These calculations will be used later on in the publication bias analyses.
The harmonic mean is used instead of the simple average of the two sample sizes because it gives more weight to the smaller sample size, which can help to reduce the potential for bias in the meta-analysis.
...
```{r, eval=FALSE}
egg_weight_model <- run_model(dat, ~ egg_weight_mean)
