...
We'll create three data sets to run a sensitivity analysis. 
...
load(here("RData", "dat2.RData"))
load(here("RData", "dat3.RData"))
# summary(mr1)
# summary(mr1_egg)
# summary(mr2)
# summary(mr2_egg)
...
VCV <- impute_covariance_matrix(dat$var_lnRR, cluster = dat$measurement_ID_A, r = 0.5)

mod <- rma.mv(lnRR, VCV, # Add `var_lnRR` to account for correlated errors between cohorts (shared_controls)
              random = list(~1|study_ID, # Identity of the study
                            ~1|Phylogeny, # Phylogenetic correlation between species
                            ~1|species_ID,
                            ~1|pfas_ID, # Type of PFAS
...
# a bit regression here


mod1 <- rma.mv(lnRR, VCV, # Add `var_lnRR` to account for correlated errors between cohorts (shared_controls)
...
orchard_plot(mod1, mod = "sample_type_P", group = "study_ID", data = dat, xlab = "lnRR")


mod2 <- rma.mv(lnRR, VCV, # Add `var_lnRR` to account for correlated errors between cohorts (shared_controls)
              mod = ~ sample_type_A,
              random = list(~1|study_ID, # Identity of the study
                            #~1|Phylogeny, # Phylogenetic correlation between species
                            ~1|species_ID,
...
orchard_plot(mod2, mod = "sample_type_A", group = "study_ID", data = dat, xlab = "lnRR")
...
```{r}
# save(m1, m1_res, mr1, mr1_egg, mr2, mr2_egg, mr3, mr3_egg, mr4, mr4_egg, file = here("Rdata", "models.RData"))
# 
# save(dat, file = "~/PhD/GitHub/PFAS_MA_MaternalTransfer_WildBirds_PILOT/RData/dat.RData")
# save(dat2, file = "~/PhD/GitHub/PFAS_MA_MaternalTransfer_WildBirds_PILOT/RData/dat2.RData")
# save(dat3, file = "~/PhD/GitHub/PFAS_MA_MaternalTransfer_WildBirds_PILOT/RData/dat3.RData")
```
