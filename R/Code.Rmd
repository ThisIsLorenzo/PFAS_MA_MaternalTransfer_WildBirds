...
---
# The following code deduplicates articles collected during the pilot search #2 and relative search strategy.
```{r - deduplication, include=FALSE}
library(tidyverse)
library(here)
library(synthesisr)
...
#Removing all punctuation and extra white spaces
